...
//console.log(new Potion()); only prints as Potion {} <anon>
...
//test checks that a potion is added correctly to Player inventory
...
//test to ensure potion is removed from inv and stat is updated on use
